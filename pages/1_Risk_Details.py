...
try:
    ...
    st.html(
        ...
        '<div class="bg-freshness error">Prediction data unavailable.</div>'
        '</div>'
    )
    st.stop()
...
entero_cls = {
    ...
    "Caution": "caution",
    "Unsafe": "unsafe"
}.get(entero_risk, "safe")

ecoli_color = (
    "#2E7D32"
    if ecoli_cls == "safe"
    else "#F57F17"
    if ecoli_cls == "caution"
    else "#C62828"
)
...
<div class="bg-content">
    ...
    <div class="bg-detail-card">
        ...
        <p>
            E. coli is an indicator of fecal contamination in recreational water.
            ...
            exceed the 235 MPN/100 mL standard.
        </p>
    </div>
    ...
    <div class="bg-detail-card">
        ...
        <p>
            Enterococcus is the primary indicator bacterium for marine and estuarine
            recreational waters. Elevated levels are associated with gastrointestinal
            illness and other health risks from water contact.
        </p>
    </div>

    <div class="bg-explainer">
        <strong>How are thresholds determined?</strong>
        <br>
        The 235 MPN/100 mL E. coli and 130 MPN/100 mL Enterococcus thresholds
        are set by the U.S. EPA and adopted by California water-quality standards
        for recreational waters. Exceeding these levels is associated with a
        statistically elevated risk of illness among swimmers and other
        water-contact recreationists.
    </div>
